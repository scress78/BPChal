...
with open(weather) as w:
    ...
    city_list = ['Albany', 'Atlanta', 'Windsor Locks', 'Nashville', 'Boise', 'Boston', 'Buffalo', 'Burbank', 'Baltimore', 'Columbus', 'Los Angeles', 'Covington', 'Washington', 'Denver', 'Dallas', 'Detroit', 'Fresno', 'Spokane', 'Washington', 'Houston', 'Las Vegas', 'New York', 'Little Rock', 'Memphis', 'Minneapolis', 'New Orleans', "Chicago", 'Portland', 'Philadelphia', 'Phoenix', 'Pittsburgh', 'Portland', 'Raleigh', 'Richmond', 'Sacramento', 'Seattle', 'San Francisco', 'Salt Lake City', 'St. Louis']
    cities_present = []
    city_checklist = []
    ...
    for row in csv_reader:
        ...
        if count != 0:
            ...
            airports = ['Detroit/Wayne', 'Wash DC/Dulles', 'NYC/LaGuardia', "Chicago O'Hare", 'Phoenix/Sky HRBR', 'Raleigh/Durham', 'Sacramento/Execu', 'St Louis/Lambert']
...
plt.xticks(np.arange(2299),new_ticks, rotation='vertical')
